...
public class FeeManagementPage extends BaseTest {
	...
	WebElement DueDate;
	@FindBy(xpath = "(//div[@class='ant-picker-cell-inner'])[35]")
	...
	@FindBy(xpath = "(//div[@class='rc-virtual-list']/div/div/div/div[1])[1]/div")
	...
	public void validateFeemanagementPage() throws InterruptedException {
		...
		WebElement esxe = driver.findElement(By.xpath("//*[@placeholder='Start date']"));
		wait.until(ExpectedConditions.elementToBeClickable(esxe));
		esxe.click();
		WaitTil(2000);
		ClickBack.click();
		WaitTil(2000);
	...
	public void feeAmount() throws InterruptedException{
		...
		StringBuilder amount1 = new StringBuilder(2);
		for (int n = 0; n < 2; n++)
		{
		...
		WaitTil(2000);
		StringBuilder amount2 = new StringBuilder(2);
		for (int n = 0; n < 2; n++)
		{
	...
	public void PaymentRequestForClass() throws InterruptedException {
		...
		String fee ="123456789";
		Random id = new Random();
		StringBuilder amount = new StringBuilder(2);
		for (int n = 0; n < 2; n++)
		{
			amount.append(fee.charAt(id.nextInt(fee.length())));
		}
	...
	public void AddOfflinePaymnet() throws InterruptedException {
		...
		String fee ="123456789";
		Random id = new Random();
		StringBuilder amount = new StringBuilder(3);
		for (int n = 0; n < 3; n++)
		{
			amount.append(fee.charAt(id.nextInt(fee.length())));
		}
	...
	public void StudentAll() throws InterruptedException {
		...
		ClickClass.click();
		WaitTil(2000);
		WebElement paymentmoney = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[1]"));
		String paymentmoneycount = paymentmoney.getText();
		System.out.println("------Overview money------" + paymentmoneycount);

		WebElement pending = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[1]"));
		String pendingmoney = pending.getText();
		System.out.println("------pending amount ------" + pendingmoney);

		WebElement paid = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[2]"));
		String paidmoney = paid.getText();
		System.out.println("------paid amount ------" + paidmoney);

		WebElement overdue = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[3]"));
		String overduemoney = overdue.getText();
		System.out.println("------overdue amount ------" + overduemoney);

		WebElement cancel = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[4]"));
		String cancelmoney = cancel.getText();
		System.out.println("------cancel amount ------" + cancelmoney);

		WebElement refund = driver.findElement(By.xpath("(//div[@class='r-c-sb'])/div[5]"));
		String refundmoney = refund.getText();
		System.out.println("------refund  amount ------" + refundmoney);

		driver.findElement(By.xpath("//span[@class='ant-select-selection-item'][@title='Week']")).click();
		WaitTil(2000);
		driver.findElement(By.xpath("//*[@class='ant-picker-clear']")).click();
		WaitTil(2000);
		driver.findElement(By.xpath("(//*[@class='ant-picker-cell ant-picker-cell-in-view'])[16]")).click();
		WaitTil(2000);
		driver.findElement(By.xpath("(//*[@class='ant-picker-cell ant-picker-cell-in-view'])[18]")).click();
		WaitTil(2000);
		driver.findElement(By.xpath("//span[@class='ant-select-selection-item'][@title='Week']")).click();
		WaitTil(2000);
	...
	public void recentActivity() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[contains(@href,'/fee-management')]")).click();
		WaitTil(5000);
		WebElement Element = driver.findElement(By.xpath("(//*[contains(.,'VIEW ALL')])[9]"));
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView();", Element);
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[contains(.,'VIEW ALL')])[9]")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[@class='classFilter'])[1]")).click();
		List<WebElement> boxes = driver.findElements(By.xpath("//*[@class='ant-popover ant-popover-placement-leftTop ']/div/div[2]/div/div/div/div/div"));
		int boxSize = boxes.size();
		System.out.println("The size of the element is: " + boxSize);
		for (int i = 0; i <boxSize; i++) {
			Thread.sleep(2000);
		...
		System.out.println("---The selection was done in first dropdown---");
		paymentRequestDetails();
		handleCalenderAndStatus();
		clickSearchButtonInActivity();
	}

	public void clickSearchButtonInActivity() throws InterruptedException {
		Thread.sleep(2000);
		WebElement ele2 = driver.findElement(
				By.xpath("(//*[@class='ant-typography ant-typography-ellipsis ant-typography-single-line'])[1]"));
		String name = ele2.getText();
		driver.findElement(By.xpath("//*[@placeholder='Search']")).sendKeys(name);
		Thread.sleep(2000);
		driver.findElement(By.xpath("//*[@class='anticon anticon-search']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@placeholder='Search']")).clear();
		Thread.sleep(3000);
		System.out.println("---search operation was successfull------");
	}

	public void paymentRequestDetails() throws InterruptedException {
		Thread.sleep(2000);
		...
		ele3.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("(//*[contains(.,'CLOSE')])[10]")).click();
		System.out.println("--------The payment request page is closed------------");

	}

	public void handleCalenderAndStatus() throws InterruptedException {
		Thread.sleep(2000);
		ClickOnCalendar1.click();
		List<WebElement> ele = driver.findElements(By.xpath("//div[@class='dropmenuBp']"));
		int elesize = ele.size();
		for (int i = 0; i < elesize; i++) {
			Thread.sleep(2000);
...
/*
		...
		driver.findElement(By.xpath("(//*[@class='anticon anticon-caret-down'])[1]")).click();
		Thread.sleep(5000);
		List<WebElement> checkBox = driver.findElements(By.xpath("//*[@class='ant-popover ant-popover-placement-leftTop ']/div/div[2]/div/div/div"));
		int size = checkBox.size();
		for (int i = 0; i < size; i++) {
			Thread.sleep(3000);
			checkBox.get(i).click();
			System.out.println("---The selected ceckbox is--- :" + checkBox.get(i));
	...
	public void Course() throws InterruptedException {
		...
		Thread.sleep(2000);
		/*
		 * ClickOnAddCourse.click(); Thread.sleep(2000); ClickOnCourseName.click();
		 * Thread.sleep(2000); SelectCourse.click(); Thread.sleep(2000);
		 */
		ClickCalendar.click();
		Thread.sleep(2000);
		Clicktoday.click();
	...
	public void StudentProfile()
	{
		...
		FeeManagement4.click();
		wait(2000);
		//click on all student 
		driver.findElement(By.xpath("(//span[@class='anticon anticon-arrow-right'])[4]")).click();
		wait(2000);
		//click on class name 
		driver.findElement(By.xpath("(//div[@class='box-shadow'])[1]")).click();
		wait(2000);
		WebElement ele=driver.findElement(By.xpath("//*[@class='ant-layout-content']/div/div[3]/div[1]"));
		...
		else 
		{
			...
			driver.findElement(By.xpath("(//div[@style='margin-left: 20px;'])[1]")).click();
			wait(2000);
			ProfileInformation();
			CourseAndFee();
			}
	...
	{
		//click on basic basic information 
		driver.findElement(By.xpath("(//*[text()='Basic information'])[1]")).click();
		wait(2000);
		//click on gender
	...
	public void CourseAndFee()
	{
		wait(2000);
		//click on course and fee
		driver.findElement(By.xpath("//*[text()='Course and fee']")).click();
		wait(2000);
		//click on class
