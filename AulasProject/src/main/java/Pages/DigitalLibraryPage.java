...
public class DigitalLibraryPage  extends BaseTest{
	...
	public void LectureNotes() throws InterruptedException, AWTException
	{
		...
		// File Location
		StringSelection select = new StringSelection("C:\\Users\\Brigosha_Guest\\Documents\\user.pdf");
		// Copy to clipboard
		...
		Thread.sleep(1000); // Press CTRL+V
		robot.keyPress(KeyEvent.VK_CONTROL);
		robot.keyPress(KeyEvent.VK_V); // Wait
		Thread.sleep(1000); // Release CTRL+V
		robot.keyRelease(KeyEvent.VK_CONTROL);
		robot.keyRelease(KeyEvent.VK_V); // Wait
		Thread.sleep(1000);
		// Press Enter
