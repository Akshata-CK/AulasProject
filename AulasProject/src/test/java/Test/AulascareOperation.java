...
public class AulascareOperation  extends BaseTest{
    LoginClass LC;
    HomePage1 HP;
	AulasCarePage1 AC;

	
	public AulascareOperation () {
		super();
	}
	...
	public void setup()throws InterruptedException{
		...
		HP = LC.DataOperatorMobileLogin(prop.getProperty("Operation1"),prop.getProperty("OTP"));
